...
<div class="card">
    ...
    <form action="" method="post" enctype="multipart/form-data"><!--el enctype permite adjuntar archivos como fotos o pdfs de momento no-->
        <div class="mb-3">
          ...
          <input type="text"
            class="form-control" name="nombreIps" id="nombreIps" aria-describedby="helpId" placeholder="Dale un nombre a la Sucursal">

        </div>
        <div class="mb-3">
          <label for="nivelSucursal" class="form-label">Nivel </label>
          <input type="text"
            class="form-control" name="nivelSucursal" id="nivelSucursal" aria-describedby="helpId" placeholder="Ingresa el nivel de la Sucursal">
        </div>
        <!-- ejemplo del enctype abajo (Foto) se sigue usando el bs5forminput -->
        <div class="mb-3">
          <label for="direccionSucur" class="form-label">Direccion</label>
          <input type="text"
            class="form-control" name="direccionSucur" id="direccionSucur" aria-describedby="helpId" placeholder="Ingresa la direccion de la Sucursal">
        </div>
