...
class PDF extends FPDF
{
   ...
   function Header()
   {
      include '../database.php';//llamamos a la conexion BD
      ...
      $this->Cell(110, 15, utf8_decode($dato_info->nombreRol), 1, 1, 'C', 0); // AnchoCelda,AltoCelda,titulo,borde(1-0),saltoLinea(1-0),posicion(L-C-R),ColorFondo(1-0)
