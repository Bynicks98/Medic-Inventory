...
<div class="card">
    ...
    <form action="" method="post" enctype="multipart/form-data"><!--el enctype permite adjuntar archivos como fotos o pdfs de momento no-->
        <div class="mb-3">
          ...
          <input type="text"
            class="form-control" name="nombreSubcat" id="" aria-describedby="helpId" placeholder="Dale un nombre a la Categoria">

        </div>
        <div class="mb-3">
          <label for="" class="form-label">Descripcion</label>
          <input type="text"
            class="form-control" name="descripcionSubcat" id="" aria-describedby="helpId" placeholder="Añade una descripcion para la Categoria">
        ...
        <!-- ejemplo del enctype abajo (Foto) se sigue usando el bs5forminput -->
           ...
           <div class="mb-3"> 
            ...
            <option value="<?php echo $subcategoria['idCATEGORIA']; ?>"><?php echo $subcategoria['nombreCat']; ?></option>
            <?php } ?>
            </select>
