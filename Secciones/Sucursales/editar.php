  ...
  <div class="card-body">
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <div class=<label for="txtID" class="form-label">ID</label>
        ...
        <input type="text" value="<?php echo $NombreSucursal; ?>" class="form-control" name="nombreIps" id=""
          aria-describedby="helpId" placeholder="Dale un nombre a la Sucursal">

      </div>
      <div class="mb-3">
        <label for="" class="form-label">Nivel </label>
        <input type="text" value="<?php echo $nivelSucursal; ?>" class="form-control" name="nivelSucursal" id=""
          aria-describedby="helpId" placeholder="Ingresa el nivel de la Sucursal">
      </div>
      <!-- ejemplo del enctype abajo (Foto) se sigue usando el bs5forminput -->
      <div class="mb-3">
        <label for="" class="form-label">Direccion</label>
        <input type="text" value="<?php echo $DireccionSucur; ?>" class="form-control" name="direccionSucur" id=""
