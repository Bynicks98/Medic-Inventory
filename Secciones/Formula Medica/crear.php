...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("INSERT INTO formulamedica (idFORMULA, estadoFormula, fechaFormula, observacionesFormula, pagoFormula) 
    VALUES (null, :estadoFormula, :fechaFormula, :observacionesFormula, :pagoFormula)");
    ...
    <div class="card-body">
        <form action="" method="post">
            <div class="mb-3">
                ...
                <input type="date" class="form-control" name="fechaFormula" id="fechaFormula" aria-describedby="helpId" placeholder="">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="observacionesFormula" id="observacionesFormula" aria-describedby="helpId" placeholder="Añade una observación">
            </div>

            <div class="mb-3">
                <label for="pagoFormula" class="form-label"><h6>Pago</h6></label>
                <input type="number" class="form-control" name="pagoFormula" id="pagoFormula" aria-describedby="helpId" placeholder="Añade un monto de pago">
            </div>
